...
TEST_CASE("DH::testRemoveEASY", "[valgrind][weight=6][type=dh]")
{
...
TEST_CASE("DH::testRemoveHard", "[valgrind][weight=10][type=dh]")
{
...
TEST_CASE("DH::testResizeOnce", "[valgrind][weight=7][type=dh]" )
{
...
TEST_CASE("DH::testResizeAll", "[valgrind][weight=11][type=dh]")
{
...
TEST_CASE("DH::testInsertEasy", "[valgrind][weight=6][type=dh]")
{
	TextFile infile( "tests/textEasy.txt" );
	DHHashTable<string, int> hashTable(32);
	int val = 0;
...
TEST_CASE("DH::testInsertHard", "[valgrind][weight=10][type=dh]")
{
	TextFile infile( "tests/textHard.txt" );
	DHHashTable<string, int> hashTable(32);
    int val = 0;
