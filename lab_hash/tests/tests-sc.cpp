...
TEST_CASE("SC::testRemoveEASY", "[valgrind][weight=6][type=sc]")
{
...
TEST_CASE("SC::testRemoveHard", "[valgrind][weight=10][type=sc]")
{
...
TEST_CASE("SC::testResizeOnce", "[valgrind][weight=7][type=sc]" )
{
...
TEST_CASE("SC::testResizeAll", "[valgrind][weight=11][type=sc]")
{
...
TEST_CASE("SC::testInsertEasy", "[valgrind][weight=6][type=sc]")
{
	TextFile infile( "tests/textEasy.txt" );
	SCHashTable<string, int> hashTable(32);
	int val = 0;
...
TEST_CASE("SC::testInsertHard", "[valgrind][weight=10][type=sc]")
{
	TextFile infile( "tests/textHard.txt" );
	SCHashTable<string, int> hashTable(32);
    int val = 0;
