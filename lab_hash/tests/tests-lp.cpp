...
TEST_CASE("LP::testRemoveEASY", "[valgrind][weight=6][type=lp]")
{
...
TEST_CASE("LP::testRemoveHard", "[valgrind][weight=10][type=lp]")
{
...
TEST_CASE("LP::testResizeOnce", "[valgrind][weight=7][type=lp]" )
{
...
TEST_CASE("LP::testResizeAll", "[valgrind][weight=11][type=lp]")
{
...
TEST_CASE("LP::testInsertEasy", "[valgrind][weight=6][type=lp]")
{
	TextFile infile( "tests/textEasy.txt" );
	LPHashTable<string, int> hashTable(32);
	int val = 0;
...
TEST_CASE("LP::testInsertHard", "[valgrind][weight=10][type=lp]")
{
	TextFile infile( "tests/textHard.txt" );
	LPHashTable<string, int> hashTable(32);
    int val = 0;
